      ...
      <Svg width={width} height={height} viewBox="0 0 150 150">
        ...
        <G id="#61dafbff">
          <Path
            fill={color}
            opacity="1.00"
            d=" M 64.09 92.99 C 84.94 72.69 105.64 52.24 126.62 32.08 C 119.51 59.95 112.23 87.77 104.99 115.60 C 91.33 108.12 77.68 100.60 64.09 92.99 Z"
          />
          <Path
            fill={color}
            opacity="1.00"
            d=" M 92.43 42.52 C 95.95 41.17 99.28 39.30 102.95 38.37 C 101.26 39.91 99.32 41.14 97.40 42.38 C 78.58 54.97 59.83 67.66 40.97 80.19 C 35.54 77.30 30.19 74.27 24.77 71.36 C 47.20 61.48 69.91 52.20 92.43 42.52 Z"
          />
          <Path
            fill={color}
            opacity="1.00"
            d=" M 62.12 98.75 C 65.76 100.63 69.33 102.66 72.87 104.73 C 69.29 109.43 65.81 114.21 62.11 118.81 C 62.10 112.12 62.07 105.43 62.12 98.75 Z"
          />
        </G>
      </Svg>
    </View>
